...
class Battle {
    ...
    endTurn() {
        const verboseBattleLog = typeof ui !== 'undefined' && ui.verboseBattleLog;
        ...
        // Verbose battle log: report TOTAL megin gained this turn per väsen
    ...
    executeSkill(attacker, defender, skillName, isPlayer, selectedAllyTarget = null) {
        ...
        if (skill.type === ATTACK_TYPES.UTILITY) {
            ...
            if (attacker.hasRune('MANNAZ')) {
                ...
                // triggered this battle, and so it also applies to utility skills that
                // never touch gifuTriggered at all (e.g. Freya's Tears).
                if (!attacker.battleFlags.mannazTeamHealTriggered && hasMannazTeamHealBindRune(attacker)) {
                    attacker.battleFlags.mannazTeamHealTriggered = true;
