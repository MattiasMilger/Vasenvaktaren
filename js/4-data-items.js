...
const TAMING_ITEMS = {
    'Sturdy Spade': {
        name: 'Sturdy Spade',
        description: 'A sturdy Spade. The well-worn wooden handle and polished steel blade look perfect for turning earth, an ideal offering for a diligently working, unseen guardian of the land. It can either be gifted to wild väsen or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Garden Rake': {
        name: 'Garden Rake',
        description: 'A weathered Garden Rake. It seems useful for tending to a farm, perhaps attracting a careful, bearded guardian. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Warm Tomtegrot': {
        name: 'Warm Tomtegröt',
        description: 'A bowl of fresh Tomtegröt. The sweet smell might attract a watchful house spirit who loves this offering. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Black Feather': {
        name: 'Black Feather',
        description: 'A large Black Feather. It carries an eerie silence, likely shed by a spectral, shrieking raven. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Burial Flowers': {
        name: 'Burial Flowers',
        description: 'A small bouquet of Burial Flowers. Their scent is mournful, calling out to a lost, wailing infant spirit. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Ghastly Lantern': {
        ...
        description: 'A sputtering Ghastly Lantern. Its light is faint and misleading, a lure for a wandering, fire-aligned spirit. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Damp Seaweed': {
        name: 'Damp Seaweed',
        description: 'A clump of Damp Seaweed. It smells strongly of the sea, a sign of a drowned sailor\'s haunting cry. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Drenched Saddle': {
        ...
        description: 'A glistening Drenched Saddle. Be cautious; a deceptive white horse might be nearby, looking for a rider. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Delicate Truffle': {
        ...
        description: 'A rare, pale fungus with a rich aroma. It\'s a highly prized delicacy that makes a nocturnal grazer drop its guard and follow its nose. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Broken Chain': {
        name: 'Broken Chain',
        description: 'A piece of a mighty Broken Chain. The metal pulses with immense, restrained power - a sign of the great wolf. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Eagle Quill': {
        name: 'Eagle Quill',
        description: 'A massive Eagle Quill. It feels impossibly light; a feather from the creator of the world\'s winds. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Silver Necklace': {
        ...
        description: 'A dazzling silver necklace. Perhaps a greedy mountain-dwelling giant dropped it while passing through. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Mossy Bark': {
        name: 'Mossy Bark',
        description: 'A thick piece of Mossy Bark. It\'s the perfect camouflage for a cunning forest Troll. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Trollmilk Bottle': {
        ...
        description: 'A strange, small Trollmilk Bottle. It seems to have been left by a sickly, irritable changeling child. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Mine Lantern': {
        name: 'Mine Lantern',
        description: 'A sturdy Mine Lantern. The light might please the beautiful spirit who guards the deep veins of ore. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
        foundText: 'You found a sturdy Mine Lantern. The light might please the beautiful spirit who guards the deep veins of ore.',
        tamingTarget: 'Gruvra'
    },
    'Shed Antlers': {
        name: 'Shed Antlers',
        description: 'A set of Shed Antlers. They whisper of the deep woods and the alluring, yet dangerous, spirit of the forest. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Waterlogged Violin': {
        ...
        description: 'A Waterlogged Violin. Its silent strings recall the melancholic, luring music of the water spirit. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
        foundText: 'You found a Waterlogged Violin. Its silent strings recall the melancholic, luring music of the water spirit.',
        tamingTarget: 'Nacken'
    },
    'Morning Dew': {
        name: 'Morning Dew',
        description: 'A jar containing shimmering Morning Dew. This ethereal substance attracts the tiny, dancing beings of the mist. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Anvil Shard': {
        name: 'Anvil Shard',
        description: 'A fragment of an Anvil Shard. It rings with a sound of skilled craftsmanship, belonging to the subterranean smiths. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Festive Midsommarkrans': {
        ...
        description: 'A festive woven flower wreath. Its radiance attracts the beautiful, light-aligned beings of creation. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Elderflower Sprig': {
        ...
        description: 'A fragrant Elderflower Sprig. Its scent is protective and ancient, a necessary offering for the fierce, watchful spirit of the Elder Tree. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Mead Horn': {
        name: 'Mead Horn',
        description: 'A chipped Mead Horn. The scent of victory and feasting lingers, attracting a valiant warrior from Valhalla. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Shield Fragment': {
        ...
        description: 'A polished Shield Fragment. It has the mark of a powerful, winged maiden who chooses the worthy slain. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Giant Rock': {
        name: 'Giant Rock',
        description: 'A surprisingly smooth Giant Rock. A piece of the raw, immense power of the ancient giants. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
        foundText: 'You found a surprisingly smooth Giant Rock. A piece of the raw, immense power of the ancient giants.',
        tamingTarget: 'Jotun'
    },
    'Glowing Coal': {
        name: 'Glowing Coal',
        description: 'A searing Glowing Coal. It burns with the endless fire of Muspelheim, attracting a fiery elemental being. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Ice Crystal': {
        name: 'Ice Crystal',
        description: 'A razor-sharp Ice Crystal. It is bone-chillingly cold, a remnant of the primordial giants of ice and mist. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Shedded Scale': {
        name: 'Shedded Scale',
        description: 'A large, slick Shedded Scale. It belonged to a massive, wingless serpent of the forgotten forests. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Gold Coin': {
        name: 'Gold Coin',
        description: 'A flawless coin of pure gold, often found in the colossal hoards of avaricious drakes. It speaks volumes of wealth and is a tempting offering to creatures driven by greed. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Fishing Hook': {
        name: 'Fishing Hook',
        description: 'A colossal Fishing Hook. Only the one who tried to catch the World Serpent could have used this. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
    ...
    'Yggdrasil Root': {
        name: 'Yggdrasil Root',
        description: 'A fragment of Yggdrasil Root. It is gnawed and ancient, a piece of the world tree itself. It can either be gifted to wild väsen to tame them or your own väsen to heal them. Be careful, only some väsen like this.',
