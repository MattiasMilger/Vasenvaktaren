// =============================================================================
// 10-core-lore.js - Lore Book Entry Definitions
// =============================================================================
...
const LORE_ENTRIES = {
    ...
    'family_odjur': {
        ...
        name: 'Odjur',
        category: 'vasen',
        desc: 'Odjur are the great supernatural beasts of Norse and Swedish myth - neither entirely animal nor spirit, but something far more primordial. They are often the monstrous offspring of gods, giants, or chaos itself, embodying the raw, untameable forces of nature. Many beasts are foretold to play decisive roles at Ragnarök, the twilight of the gods. The word itself simply means "beast" or "monster" in Swedish, reflecting how these creatures defy ordinary classification.',
    ...
    'family_alv': {
        ...
        name: 'Alv',
        category: 'vasen',
        desc: 'Alver are mysterious humanoid beings of Norse mythology, divided by Snorri Sturluson in the Prose Edda into the ljusalver (light elves) who dwell in Alfheim, and the svartalver (dark elves) who live underground in Nidavelir / Svartalfheim. The ljusalver are described as more radiant than the sun, while the svartalver are darker than pitch. These elves are renowned master craftsmen who forged some of the greatest treasures in Norse myth, including Mjölnir and the binding chain Gleipnir.',
    ...
    'family_ande': {
        ...
        name: 'Ande',
        category: 'vasen',
        desc: 'Andar are spirits of a mystical or semi-divine nature, distinguished from the simpler phantoms by their connection to greater cosmic powers. They serve gods, guard sacred places, or fulfil divine roles in the ordering of the world. The Swedish word "ande" means "spirit" or "breath," reflecting the ancient belief that these spirits exist on the boundary between the physical and the divine.',
        source: 'Norse Mythology / Swedish Folklore',
        heritage: 'Norse',
        unlockType: 'family',
        unlockKey: 'Ande'
    ...
    'family_drake': {
        ...
        name: 'Drake',
        category: 'vasen',
        desc: 'Drakar are the great serpents of Norse mythology and European legend. In Norse tradition these serpents are deeply tied to cosmic forces, often guarding immense hoards of stolen gold or lurking in the black depths of the sea. They frequently serve as ultimate symbols of greed and destruction, prophesied to clash with gods and heroes at the end of the world. The word "drake" shares its root with the Latin "draco" and the Greek "drakōn," meaning "serpent" or "one who gazes sharply."',
    ...
    'vasen_landvatte': {
        ...
        name: 'Landvätte',
        category: 'vasen',
        desc: 'The landvätte is a  protector of a specific stretch of wilderness, hill, or natural landmark. In Old Norse sources, including the Heimskringla, King Odin commanded that all Viking ships approaching the Norwegian coast lower their dragon prows so as not to frighten the landvættr - the land pranksters who protect the country. Swedish folk belief inherited this tradition, holding that disturbing a landvätte\'s territory would bring misfortune.',
    ...
    'vasen_gardstomte': {
        ...
        name: 'Gårdstomte',
        category: 'vasen',
        desc: 'The gårdstomte is the tender of the farmstead - the barns, the livestock, the outbuildings, and the fields. It is depicted as a small, bearded, elderly man who works invisibly by night to keep the farm in order. The gårdstomte demands an annual gift of a bowl of porridge (gröt) with a lump of butter on top; neglecting this offering invites disaster, as this prankster may torment the animals, spoil the milk, or move to another farm entirely.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
    ...
    'vasen_hustomte': {
        ...
        name: 'Hustomte',
        category: 'vasen',
        desc: 'The hustomte is the beloved house tender found in nearly every Swedish farmhouse tradition. It lives near the hearth or beneath the floorboards, silently watching over the family and their home. The hustomte is especially associated with the midwinter Yule season, when it traditionally received its most important offering: a bowl of warm sweet porridge (tomtegröt). The modern image of the Swedish Yule gnome (Jultomte) descends directly from this ancient folk tradition.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Hustomte'
    ...
    'vasen_nattramn': {
        ...
        name: 'Nattramn',
        category: 'vasen',
        desc: 'The nattramn is a raven phantom of ill omen in Swedish folklore, believed to be the restless soul of a builder who was walled alive into a foundation to strengthen it - a practice said to have occurred during the construction of churches and castles. Its shrieking cry heard at night was a death omen. In some traditions this phantom has no flesh, only a skeleton of hollow bones, and if you could count all its feathers before dawn you would be protected from its curse.',
    ...
    'vasen_myling': {
        ...
        name: 'Myling',
        category: 'vasen',
        desc: 'The myling (also "myrling" or "utbörding") is one of the most chilling phantoms in Swedish folklore: the grave phantom of an infant who was murdered or abandoned by its mother before receiving a name and a proper burial. Condemned to wander the wilderness, it would leap onto the backs of lone travelers and demand to be carried to the nearest churchyard for proper burial. With each step toward the church, it grew heavier, often crushing its unwilling carrier. These phantoms were the embodiment of infanticide\'s cultural shame.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Myling'
    ...
    'vasen_irrbloss': {
        ...
        name: 'Irrbloss',
        category: 'vasen',
        desc: 'The irrbloss (also "lyktgubbe") is the Swedish name for the will-o\'-wisp, the eerie bog phantom seen hovering over bogs and marshes. Folk belief held these phantoms to be the souls of sinful or dishonest men - surveyors who had falsified boundaries, cheats, and murderers - condemned to wander eternally between the living world and the realm of the dead. They carry flickering lanterns to lure travelers astray into treacherous quicksand, deep mires, or over hidden cliffs, punishing the living for the sins of their past.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Irrbloss'
    ...
    'vasen_strandvaskare': {
        ...
        name: 'Strandvaskare',
        category: 'vasen',
        desc: 'The strandvaskare is a grim phantom in Swedish folklore, born from the restless soul of a drowned sailor whose body washed ashore without being returned home. Bound for eternity to the jagged coastline where it perished, this bitter spirit harbors a deep resentment toward the living. On foggy or stormy nights, the phantom vents its agony by projecting deceptive, flickering lantern lights and mimicking the desperate wails of distressed mariners, actively luring passing vessels toward treacherous reefs to share its watery fate.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
    ...
    'vasen_backahast': {
        ...
        name: 'Bäckahäst',
        category: 'vasen',
        desc: 'The bäckahäst is a river horse from Swedish folklore that lurks near rivers and streams in the guise of a beautiful, shimmering white stallion. Anyone who mounts this beast finds they cannot dismount - the horse then plunges into the water and drowns its rider. This creature is closely related to the Scottish kelpie and the Norwegian nykur. A common protective charm was to name the horse with the words "brook horse" aloud, breaking the spell.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Backahast'
    ...
    'vasen_bjara': {
        ...
        name: 'Bjära',
        category: 'vasen',
        desc: 'The bjära (also "mjölkhare") is a thieving familiar constructed by a witch from wood shavings, yarn, and hair, then animated with three drops of her own blood. Taking the form of a bloated hare or a rolling ball of yarn, this beast slinks into neighboring farms to suck milk directly from the udders of cows. Upon returning, it vomits the stolen bounty into its mistress\'s churn. This creature represents deep-seated rural anxieties regarding livestock illness and the suspicion that a neighbor\'s sudden prosperity was the result of magical theft.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Bjara'
    ...
    'vasen_fenrir': {
        ...
        name: 'Fenrir',
        category: 'vasen',
        desc: 'The Fenris-wolf is the most terrifying beast in Norse mythology, the monstrous son of Loki and the giantess Angrboda. The gods, fearful of a prophecy that this beast would kill Odin at Ragnarök, attempted to bind him with chains. He broke every chain of iron and rock until the dwarves forged Gleipnir - a magical ribbon made from impossible things. When Ragnarök comes, Fenrir will swallow the sun, break free, and swallow Odin himself.',
        source: 'Prose Edda / Poetic Edda',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Fenrir'
    ...
    'vasen_rasvelg': {
        ...
        name: 'Räsvelg',
        category: 'vasen',
        desc: 'Räsvelg is the giant eagle who sits at the northern edge of the world in Norse cosmology. According to the Poetic Edda\'s poem Vafþrúðnismál, all the winds that blow across the world are created by the beating of this primordial beast\'s enormous wings. Positioned at the end of the sky, the giant eagle gazes over all creation with piercing eyes. It also plays a crucial role in Eddic descriptions of Yggdrasil, where it perches at the very apex of the World Tree, watching the cosmos unfold.',
    ...
    'vasen_backatroll': {
        ...
        name: 'Bäckatroll',
        category: 'vasen',
        desc: 'The bäckatroll is a bridge troll found throughout Scandinavian folklore. Unlike their larger mountain-dwelling kin, these troll are strictly territorial, bound to a specific bridge or waterway. Known for being temperamental and greedy, they often demand a toll - be it a coin, a riddle, or a gift - for safe passage. If disrespected or ignored, a bridge troll is said to lash out by sabotaging the crossing or manipulating the water levels of their domain.',
    ...
    'vasen_gryningstroll': {
        ...
        name: 'Gryningstroll',
        category: 'vasen',
        desc: 'The gryningstroll is a troll that demonstrates the ancient rule: sunlight turns troll to stone. Unlike their cave-dwelling kin, these troll are often caught in the open by the first rays of the sun, either due to their own slow-wittedness or a refusal to leave a task unfinished. They are frequently found as solitary, moss-covered statues on hillsides or near crossroads. Folklore suggests that a stone troll frozen in place still retains a glimmer of its former life, waiting in a cold, petrified slumber for a night that never ends.',
        source: 'Scandinavian Folklore / Asbjørnsen & Moe (Norske Folkeeventyr); Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Scandinavian',
        unlockType: 'vasen',
    ...
    'vasen_gruvra': {
        ...
        name: 'Gruvrå',
        category: 'vasen',
        desc: 'The gruvrå is a mine warden - a beautiful, pale figure who may appear as a benevolent guide or a deadly seductress depending on the miner\'s behavior. Sweden\'s long mining history, particularly in the Bergslagen region, gave rise to a rich tradition of these underground guardians. Miners would leave offerings or and observe strict protocols: never whistle underground, never speak of the warden directly, and always treat the mine\'s resources with respect. Knocking on the tunnel walls was often interpreted as her warning of an imminent collapse.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Gruvra'
    ...
    'vasen_huldra': {
        ...
        name: 'Huldra',
        category: 'vasen',
        desc: 'The huldra is a seductive forest guardian of Scandinavian folklore, known for her captivating beauty and the cow\'s tail hidden beneath her clothes. Though sometimes appearing with a soot-stained, charred look, classic tales speak of her protecting mountain pastures and deep woods. Helpful to courteous hunters and herders, she bestows great fortune on those who treat her with respect, but brings ruin to those who cross her.',
        source: 'Scandinavian Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Scandinavian',
        unlockType: 'vasen',
        unlockKey: 'Huldra'
    ...
    'vasen_mara': {
        ...
        name: 'Mara',
        category: 'vasen',
        desc: 'The mara is a dream warden who wanders at night to torment others. She is the personification of the "night-press," a crushing weight felt upon the chest during sleep that leaves the victim unable to breathe. Famous for weaving "marlockar" (impossible knots) into the hair of humans and the manes of horses, she was said to ride animals until they were found exhausted at dawn. To stop this warden, peasants would point shoes away from the bed or plug the keyhole to trap her in her physical form.',
    ...
    'vasen_alva': {
        ...
        name: 'Älva',
        category: 'vasen',
        desc: 'The älva is a small, ethereal twilight elf strongly associated with wind, flickering lights, and the half-light of dusk and dawn. Unlike the majestic norse alver, the Swedish folkloristic älva is more akin to a fairy - tiny, capricious, and riding the high currents of the forest canopy. Contact with this elf was believed to cause "älvablåst" (elf-blast), a sudden illness explained as being breathed upon by an elf. Their appearance as flickering lights among the trees could bring either unexplained good fortune or sudden sickness to those who encountered them.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Alva'
    ...
    'vasen_dimalva': {
        ...
        name: 'Dimälva',
        category: 'vasen',
        desc: 'The dimälva is a mist elf, a variant of the Swedish älva distinguished by its affinity for water and morning fog rather than wind and canopy light. Where the ordinary elf rides high breezes, the dimälva clings to the surface of lakes and rivers, weaving a supernatural shroud of mist that blurs the boundary between water and land. Swedish lakeside communities spoke of mornings when the water\'s edge became impossible to discern, and those who waded in too confidently would find the ground giving way beneath them. This elf was described as nearly invisible - a faint shimmer within the fog, glimpsed only when the light struck it from just the right angle.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Dimalva'
    ...
    'vasen_svartalv': {
        ...
        name: 'Svartalv',
        category: 'vasen',
        desc: 'The svartalv is a masterful cavern elf of Norse mythology, living underground in Nidavelir / Svartalfheim. They are seekers of rare and precious materials, bending the rules of creation to craft magical artifacts for the Gods. According to the Prose Edda, these elves forged some of the most important objects in Norse myth: Gleipnir (the magical ribbon binding Fenrir), Gungnir (Odin\'s spear), Mjölnir (Thor\'s hammer), and Draupnir (Odin\'s self-replicating gold ring).',
        source: 'Prose Edda (Snorri Sturluson)',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Svartalv'
    ...
    'vasen_ljusalv': {
        ...
        name: 'Ljusalv',
        category: 'vasen',
        desc: 'The ljusalv is a radiant light elf who dwells in Alfheim, described in the Prose Edda as the most beautiful of realms. Snorri Sturluson describes them as "more radiant than the sun in appearance," aligning this elf with light, fertility, goodness, and the Vanir gods. Their realm was given as a gift to the god Freyr. While the exact nature of the ljusalver remains somewhat mysterious in the sources, they represent the benevolent, life-affirming face of elven beings in Norse cosmology.',
        source: 'Prose Edda (Snorri Sturluson)',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Ljusalv'
    ...
    'vasen_dvarg': {
        ...
        name: 'Dvärg',
        category: 'vasen',
        desc: 'The dvärg is a fiery forge elf of Norse myth. Masters of fire and iron, they dwell in the deep heart of the mountain where the heat of the earth itself fuels their craft. Where others see raw stone and ore, these elves see legendary weapons and artifacts waiting to be born. They are reclusive and territorial, emerging only when materials worthy of their skill are brought before them. Some Norse sources equate the dvärgar with dwarves entirely, though others suggest they are a distinct order of underground elves united by their unmatched mastery of fire and the forge.',
    ...
    'vasen_hyllemor': {
        ...
        name: 'Hyllemor',
        category: 'vasen',
        desc: 'Hyllemor is the Elder Tree spirit inhabiting the elder tree (Sambucus nigra), found across Scandinavian folk tradition. Before cutting any elder wood, one must ask this spirit\'s permission aloud and wait for her consent. Failure to do so brings extreme misfortune: illness, broken furniture made from the wood, and even death. The elder tree was considered sacred across much of Northern Europe, and its white flowers and dark berries were used in protective charms and medicine.',
        source: 'Scandinavian Folklore',
        heritage: 'Scandinavian',
        unlockType: 'vasen',
        unlockKey: 'Hyllemor'
    ...
    'vasen_valkyria': {
        ...
        name: 'Valkyria',
        category: 'vasen',
        desc: 'Valkyria is a winged combat spirit who rides over battlefields at Odin\'s command, selecting which warriors shall die and which shall live. These spirits escort the chosen fallen to Valhalla, where the warriors become Einherjar. Valkyries appear as armored maidens riding through the sky and across the rainbow bridge Bifröst. In later Romantic tradition they became idealized warrior-women, but in older sources they are often portrayed as fearsome and inexorable agents of fate.',
        source: 'Prose Edda / Poetic Edda',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Valkyria'
    ...
    'vasen_fylgja': {
        ...
        name: 'Fylgja',
        category: 'vasen',
        desc: 'The fylgja is a flame-bound spirit in Norse belief, inseparably bound to an individual\'s soul from birth until death. It typically takes the form of an animal that reflects the person\'s inner nature, or occasionally a radiant female figure. This spirit cannot be seen by ordinary people in waking life - only those with the gift of second sight, or those close to death, may perceive it. In the Icelandic sagas, seeing one\'s own fylgja is invariably an omen of imminent death. After its bearer dies, the fylgja passes on to the next member of the family, carrying the accumulated fate of the bloodline forward.',
    ...
    'vasen_jotun': {
        ...
        name: 'Jotun',
        category: 'vasen',
        desc: 'The jotun (alternatively jätte or turs) is a primordial giant of Norse cosmology - an ancient, immense being who represents the raw chaos that the Aesir gods constantly combat to contain. These giants inhabited Jotunheim beyond the great barrier of Midgård. Despite being home to the gods\' great enemies, the line between gods and giants is surprisingly blurred: Odin, Thor, and Freyr all have giant ancestry, and many jötnar are depicted as wise counselors rather than mindless brutes. Their name may derive from a word meaning "devourer."',
        source: 'Prose Edda / Poetic Edda',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Jotun'
    ...
    'vasen_eldturs': {
        ...
        name: 'Eldturs',
        category: 'vasen',
        desc: 'The eldturs is a fire giant from Muspelheim, the primordial realm of fire in Norse cosmology. Together they are known as the Sons of Muspel, and are led by the giant Surtr ("the black one"), destined to march forth at Ragnarök and set the world ablaze, consuming gods and men alike. In the beginning of time, the sparks and embers that flew from Muspelheim into the primordial void of Ginnungagap helped ignite the process of creation itself when they met the ice of Niflheim.',
        source: 'Prose Edda (Snorri Sturluson)',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Eldturs'
    ...
    'vasen_jormungandr': {
        ...
        name: 'Jörmungandr',
        category: 'vasen',
        desc: 'Jörmungandr is the World serpent whose coils encircle all of Midgård (the world of humans), lying in the great ocean and biting its own tail - making it an Ouroboros, a symbol of cyclical eternity. This serpent is the child of Loki and the giantess Angrboda. Thor and Jörmungandr are destined nemeses: at Ragnarök, Thor will slay the serpent but walk only nine steps before dying from its venom. The famous tale of Thor fishing for this World serpent with a giant ox-head appears in the poem Hymiskviða.',
    ...
    'vasen_nidhogg': {
        ...
        name: 'Nidhögg',
        category: 'vasen',
        desc: 'Nidhögg is a root serpent who eternally gnaws at the roots of Yggdrasil, the cosmic World Tree that holds the nine realms together. This serpent\'s ceaseless gnawing is an act of cosmic dissolution - a constant threat to the fabric of existence. At Ragnarök, Nidhögg will fly with corpses on its wings across the ruined landscape. It is described in the poem Völuspá as surviving the end of the world, suggesting it belongs to whatever comes after.',
    ...
    'item_broken_chain': {
        ...
        name: 'Broken Chain',
        category: 'items',
        desc: 'The chains used to bind the wolf beast Fenrir were forged by the dwarves at the gods\' request - but this beast broke every iron and rock chain they made. The dwarves then forged Gleipnir, a magical ribbon made from six impossible things: the sound of a cat\'s footsteps, the beard of a woman, the roots of a mountain, the sinews of a bear, the breath of a fish, and the spittle of a bird. Fenrir agreed to be bound only if a god placed a hand in his mouth as surety - Tyr sacrificed his hand to accomplish it. Only a fragment of a broken chain remains as a relic.',
        source: 'Prose Edda (Snorri Sturluson)',
        heritage: 'Norse',
        unlockType: 'item',
    ...
    'item_fishing_hook': {
        ...
        name: 'Fishing Hook',
        category: 'items',
        desc: 'The Hymiskviða (Song of Hymir) in the Poetic Edda tells of Thor\'s famous fishing expedition with the giant Hymir. Using the head of Hymir\'s ox as bait on an enormous hook, Thor cast his line into the ocean and caught Jörmungandr, the World serpent. He hauled this serpent to the surface, and the two stared into each other\'s eyes - their destined final combat almost occurring centuries before Ragnarök. Hymir panicked and cut the line, letting the World serpent sink back into the depths.',
    ...
    'item_yggdrasil_root': {
        ...
        name: 'Yggdrasil Root',
        category: 'items',
        desc: 'Yggdrasil ("Ygg\'s steed" - Ygg being one of Odin\'s names) is the immense ash tree at the center of Norse cosmology that connects all nine realms. Its three roots reach to Asgård (where a well of wisdom lies), to Jotunheim (where Mimir\'s Well holds cosmic knowledge), and to Niflheim (where the terrifying serpent Nidhögg endlessly gnaws). The gods hold their daily council at Yggdrasil. A fragment of its root carries the energy of the cosmos itself.',
        source: 'Prose Edda / Poetic Edda',
        heritage: 'Norse',
        unlockType: 'item',
    ...
    'item_brass_cowbell': {
        key: 'item_brass_cowbell',
        name: 'Brass Cowbell',
        category: 'items',
        desc: 'In Scandinavian folk belief, iron and ringing brass bells were essential for protection against forest spirits and wild beasts when driving cattle up to mountain pastures (fäbod). The clear chime of a bell served to guide stray cattle home and keep supernatural entities at bay. However, the allure of the huldra is closely tied to domestic herds - a ringing cowbell acts as a familiar beacon, capable of coaxing her out from the deep woods.',
        source: 'Scandinavian Folk Tradition',
        heritage: 'Scandinavian',
        unlockType: 'item',
        unlockKey: 'Brass Cowbell'
    },
    ...
    'location_trollskogen': {
        ...
        name: 'Trollskogen',
        category: 'locations',
        desc: 'Trollskogen ("Troll Forest") evokes the ancient Swedish tradition of the enchanted deep forest - a space outside civilized order where dangerous beings dwell and human rules cease to apply. Swedish folklore is filled with accounts of people entering old-growth forests and encountering troll, wardens, and other beings. The forest canopy blocking sunlight was particularly associated with danger, as sunlight was the primary protection against many supernatural threats, especially troll who turn to stone in daylight. Several real locations in Sweden bear this name, most famously on the island of Öland.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'zone',
        unlockKey: 'ZONE1'
