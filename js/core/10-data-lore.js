...
const LORE_ENTRIES = {
    ...
    'item_fishing_hook': {
        ...
        name: 'Fishing Hook',
        category: 'items',
        desc: 'The Hymiskviða (Song of Hymir) in the Poetic Edda tells of Thor\'s famous fishing expedition with the giant Hymir. Using the head of Hymir\'s ox as bait on an enormous hook, Thor cast his line into the ocean and caught Jörmungandr, the World serpent. He hauled this serpent to the surface, and the two stared into each other\'s eyes - their destined final battle almost occurring centuries before Ragnarök. Hymir panicked and cut the line, letting the World serpent sink back into the depths.',
