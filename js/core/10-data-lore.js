...
const LORE_ENTRIES = {
    ...
    'family_ra': {
        ...
        name: 'Rå',
        category: 'vasen',
        desc: 'Rå are the seductive, nature-bound spirits who serve as wardens of specific natural domains - the forest, the water, the mine, the marsh. They typically appear as strikingly beautiful beings who can enchant hunters, fishermen, and miners with irresistible allure. Their true nature is always betrayed by a physical flaw: a hollow back, a cow\'s tail, or backwards feet. Those who fall under a rå\'s power often waste away or vanish entirely. The word "rå" is cognate with Old Norse "rá," meaning a ruler or warden.',
    ...
    'family_drake': {
        ...
        name: 'Drake',
        category: 'vasen',
        desc: 'Drakar are the great serpentine dragons of Norse mythology and European legend. In Norse tradition they are deeply tied to cosmic forces. The word "drake" shares its root with the Latin "draco" and the Greek "drakōn," meaning "serpent" or "one who gazes sharply."',
    ...
    'vasen_backatroll': {
        ...
        name: 'Bäckatroll',
        category: 'vasen',
        desc: 'The Bäckatroll is a solitary guardian found throughout Scandinavian folklore. Unlike their larger mountain-dwelling kin, these trolls are strictly territorial, bound to a specific bridge or waterway. Known for being temperamental and greedy, they often demand a toll - be it a coin, a riddle, or a gift - for safe passage. If disrespected or ignored, they are said to lash out by sabotaging the crossing or manipulating the water levels of their domain.',
    ...
    'vasen_gruvra': {
        ...
        name: 'Gruvrå',
        category: 'vasen',
        desc: 'The Gruvrå is the female warden of the mine - a beautiful, pale woman who may appear as a benevolent guide or a deadly seductress depending on the miner\'s behavior. Sweden\'s long mining history, particularly in the Bergslagen region, gave rise to a rich tradition of mine spirits. Miners would leave offerings and observe strict protocols: never whistle underground, never speak of the rå directly, and always treat the mine\'s resources with respect. The German Berggeist is closely related.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Gruvra'
    ...
    'vasen_svartalv': {
        ...
        name: 'Svartalv',
        category: 'vasen',
        desc: 'The svartalv is a masterful subterranean artisan of Norse mythology, living underground in Nidavelir / Svartalfheim. They are seekers of rare and precious materials, bending the rules of creation to craft magical artifacts for the Gods. According to the Prose Edda, the svartalver forged some of the most important objects in Norse myth: Gleipnir (the magical ribbon binding Fenrir), Gungnir (Odin\'s spear), Mjölnir (Thor\'s hammer), and Draupnir (Odin\'s self-replicating gold ring).',
        source: 'Prose Edda (Snorri Sturluson)',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Svartalv'
    ...
    'vasen_dvarg': {
        ...
        name: 'Dvärg',
        category: 'vasen',
        desc: 'The Dvärg is a fiery forge-master of Norse myth. Masters of fire and iron, they dwell in the deep heart of the mountain where the heat of the earth itself fuels their craft. Where others see raw stone and ore, the Dvärgar see legendary weapons and artifacts waiting to be born. They are reclusive and territorial, emerging only when materials worthy of their skill are brought before them. Some Norse sources equate the Dvärgar with dwarves entirely, though others suggest they are a distinct order of underground folk united by their unmatched mastery of fire and the forge.',
    ...
    'vasen_lindorm': {
        ...
        name: 'Lindorm',
        category: 'vasen',
        desc: 'The Lindorm is a great wingless serpentine dragon of Scandinavian folklore, distinguished from the fire-breathing European dragon by its serpentine form. Lindorms appear throughout Swedish folk ballads and fairy tales, often as cursed princes or as terrifying beasts slain by heroes. One of the most famous Swedish folk tales, "Prins Lindorm," tells of a prince cursed to live as a serpent who can only be freed through love and sacrifice. Lindorms were associated with the deep forests.',
    ...
    'vasen_vitorm': {
        ...
        name: 'Vitorm',
        category: 'vasen',
        desc: 'The Vitorm is the fabled King of Serpents and a creature of immense wisdom in Scandinavian legend. Extremely rare and snow-white in color, it is said to be the master of all crawling things. According to folklore, the Vitorm possesses a supernatural essence; those brave enough to taste its flesh or lick its scales are granted the ability to understand the language of birds and gain deep knowledge of the earth\'s hidden secrets.',
