...
const LORE_ENTRIES = {
    ...
    'vasen_fenrir': {
        ...
        swedishDesc: 'Fenrisulven är den mest skräckinjagande av alla ulvar i nordisk mytologi, det monstruösa barnet av Loke och jättinnan Angrböda. Gudarna, rädda för en profetia att Fenrir skulle döda Oden vid Ragnarök, försökte binda honom med kedjor. Han bröt varje järn- och stenkedja tills dvärgar smidde Gleipner - ett magiskt band gjort av omöjliga ting. När Ragnarök kommer ska Fenrir svälja solen, frigöra sig och svälja Oden själv.',
        source: 'Prose Edda / Poetic Edda',
        heritage: 'Norse',
        unlockType: 'vasen',
        unlockKey: 'Fenrir'
    ...
    'ability_enchanting_song': {
        ...
        swedishName: 'Förtrollande Sång (Enchanting Song)',
        category: 'abilities',
