...
const LORE_ENTRIES = {
    ...
    'family_alv': {
        ...
        swedishDesc: 'Alvar (singular: alv) är de älvlika varelserna i nordisk mytologi, indelade av Snorri Sturluson i Prosa-Eddan i ljusalverna som bor i Alfheim, och svartalverna som lever under jord i Nidavelir / Svartalfheim. Ljusalverna beskrivs som mer strålande än solen, medan svartalverna är mörkare än beck. Svartalverna är berömda mästerhantverkare som smidde några av de största skatterna i nordisk myt, däribland Mjölnir och bindningskedjan Gleipnir.',
