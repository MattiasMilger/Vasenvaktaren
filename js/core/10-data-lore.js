...
const LORE_ENTRIES = {
    ...
    'vasen_huldra': {
        ...
        name: 'Huldra',
        category: 'vasen',
        desc: 'The huldra is a woodland warden of striking, soot-stained beauty, known for her long ashen hair, quiet grace, and the cow\'s tail she hides beneath her clothing. She appears to wanderers as a lone woman in the deep, scorched wilderness, helpful to the respectful and perilous to the arrogant. Tales speak of her guiding hunters to bountiful game, guarding stray cattle from the embers, and shaping the fortunes of those who cross her path. She is closely related to the Swedish skogsrå, yet uniquely remembered for her fierce, protective influence over both lonely foresters and highland herders.',
        source: 'Scandinavian Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Scandinavian',
        unlockType: 'vasen',
        unlockKey: 'Huldra'
    ...
    'vasen_jormungandr': {
        ...
        name: 'Jörmungandr',
        category: 'vasen',
        desc: 'Jörmungandr is the World serpent whose coils encircle all of Midgard (the world of humans), lying in the great ocean and biting its own tail - making it an Ouroboros, a symbol of cyclical eternity. This serpent is the child of Loki and the giantess Angrboda. Thor and Jörmungandr are destined nemeses: at Ragnarök, Thor will slay the serpent but walk only nine steps before dying from its venom. The famous tale of Thor fishing for this World serpent with a giant ox-head appears in the poem Hymiskviða.',
