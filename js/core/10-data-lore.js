...
const LORE_ENTRIES = {
    ...
    'family_drake': {
        ...
        name: 'Drake',
        category: 'vasen',
        desc: 'Drakar are the great serpents of Norse mythology and European legend. In Norse tradition these serpents are deeply tied to cosmic forces. The word "drake" shares its root with the Latin "draco" and the Greek "drakōn," meaning "serpent" or "one who gazes sharply."',
    ...
    'vasen_strandvaskare': {
        ...
        name: 'Strandvaskare',
        category: 'vasen',
        desc: 'The Strandvaskare (shore washer) is a shore phantom in Swedish folklore, the tormented ghost of a drowned sailor eternally condemned to haunt the shoreline where it perished. It wails and lures ships toward the reef with deceptive lights and sounds. This phantom shares similarities with the "Bean Nighe" (the washer at the ford) found in Celtic tradition and with the banshee - all representing a spectral harbinger encountered near water who portends death.',
        source: 'Swedish Folklore',
        heritage: 'Swedish',
        unlockType: 'vasen',
    ...
    'vasen_rasvelg': {
        ...
        name: 'Räsvelg',
        category: 'vasen',
        desc: 'Räsvelg is a giant eagle who sits at the northern edge of the world in Norse cosmology. According to the Poetic Edda\'s poem Vafþrúðnismál, all the winds that blow across the world are created by the beating of this beast\'s enormous wings. The giant eagle is positioned at the end of the world, gazing over all creation. It also plays a role in Eddic descriptions of Yggdrasil, where an eagle perches at the top of the World Tree.',
    ...
    'vasen_gruvra': {
        ...
        name: 'Gruvrå',
        category: 'vasen',
        desc: 'The Gruvrå is the mine warden - a beautiful, pale figure who may appear as a benevolent guide or a deadly seductress depending on the miner\'s behavior. Sweden\'s long mining history, particularly in the Bergslagen region, gave rise to a rich tradition of mine wardens. Miners would leave offerings and observe strict protocols: never whistle underground, never speak of the warden directly, and always treat the mine\'s resources with respect. The German Berggeist is closely related.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'vasen',
        unlockKey: 'Gruvra'
    ...
    'vasen_huldra': {
        ...
        name: 'Huldra',
        category: 'vasen',
        desc: 'The Huldra is a charred woodland warden of striking beauty, known for her long hair, quiet grace, and the cow\'s tail she hides beneath her clothing. She appears to wanderers as a lone woman in the deep woods, helpful to the respectful and perilous to the arrogant. Tales speak of her guiding hunters to game, guarding cattle, and shaping the fortunes of those who cross her path. She is closely related to the Swedish Skogsrå, yet remembered for her influence over both hunters and herders.',
        source: 'Scandinavian Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Scandinavian',
        unlockType: 'vasen',
        unlockKey: 'Huldra'
    ...
    'item_burial_flowers': {
        ...
        name: 'Burial Flowers',
        category: 'items',
        desc: 'In Swedish folk belief, an infant who died without baptism - especially one murdered or abandoned - could not pass on to rest and instead became a Myling, a grave phantom. The only way to free such a phantom was to give it a proper Christian burial in consecrated ground, complete with the appropriate rites. Flowers placed on a grave were seen as both an offering to the deceased and as a marker for the living - confirming that the dead had been properly honored and laid to rest.',
        source: 'Swedish Folklore / Hyltén-Cavallius (Svenska Folkets Sagohäfder)',
        heritage: 'Swedish',
        unlockType: 'item',
